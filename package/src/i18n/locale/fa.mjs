export default {
    ...
    login: {
        ...
        email: 'ایمیل',
        password: 'پسورد',
        remmember: 'من را به خاطر داشته باش',
        qustion: 'هنوز عضو نیستید ؟ ',
        signup: 'ثبت نام',
    ...
    signup: {
        ...
        rules: 'با قوانین بیتوکردیت موافقم.',
    ...
    error: {
        ...
        rePassword: 'تکرار رمز عبور با رمز عبور وارد شده یکسان نیست',
        name: 'نام را به طور صحیح وارد نمایید',
        rules: 'موافقت خود با قوانین بیتوکریدیت را اعلام نمایید'
    },
    sweetAlert: {
